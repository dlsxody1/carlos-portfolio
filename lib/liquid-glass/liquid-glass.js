// Vendored from https://github.com/dashersw/liquid-glass-js (MIT, (c) 2025 Armagan Amcalar).
// Changes: ES module, html2canvas-pro (oklch 지원), console.log 제거, 스냅샷에서 <canvas> 제외.
  ...
  capturePageSnapshot() {
    html2canvas(document.body, {
      ...
      ignoreElements: function (element) {
        ...
        // (vendored 수정) 다른 WebGL 캔버스를 복제하며 getContext('2d')를 먼저 잡아 R3F 컨텍스트 생성을 깨뜨리므로 제외
        return (
